...
function main() {
    ...
    console.log("Length of LIS (Space Optimized 1):", LIS_Tabulation_SpaceOptimized1(arr));
    console.log("Length of LIS (Space Optimized 2):", LIS_Tabulation_SpaceOptimized2(arr));
